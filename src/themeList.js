// List of all available PrimeReact themes (from node_modules/primereact/resources/themes)
export const primeThemes = [
  ...
  'fluent-light',
  'lara-dark-blue', 'lara-dark-cyan', 'lara-dark-green', 'lara-dark-indigo', 'lara-dark-pink', 'lara-dark-purple', 'lara-dark-teal',
  'lara-light-amber', 'lara-light-blue', 'lara-light-cyan', 'lara-light-green', 'lara-light-indigo', 'lara-light-pink', 'lara-light-purple', 'lara-light-teal',
